...
rm -rf ImprovedBlizzardUI_Classic/libs/Ace3/tests/check_globals.sh
rm -rf ImprovedBlizzardUI_Classic/libs/Ace3/tests/runall.sh
rm -rf ImprovedBlizzardUI_Classic/libs/Ace3/tests/runall.bat
